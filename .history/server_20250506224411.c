...
void handle_connection(int client_sock, int verbose) {
    ...
    // Print the received request if -v flag is used
    if (verbose) {
...
int main(int argc, char *argv[]) {
    ...
    while (1) {
        ...
        handle_connection(client_sock, verbose);  // Handle the client connection
    }
